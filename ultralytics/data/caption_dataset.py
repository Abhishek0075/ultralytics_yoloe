...
from ultralytics.data.transforms import Compose
...
class YOLOCaptionTrainerFromScratch:
    ...
    This trainer modifies the text embedding generation to use captions from text files
    instead of predefined class names.
    """
